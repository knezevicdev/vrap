...
var dealSchema = ObjectSchema({
  dealSummary: ObjectSchema({
    dealStatus: ObjectSchema({
      status: StringSchema().defined(),
      step: StringSchema().defined()
    }).defined(),
    inventory: ObjectSchema({
      pricing: ObjectSchema({
        listPrice: NumberSchema().defined()
      }).defined(),
      vehicle: ObjectSchema({
...
var userSchema = ObjectSchema({
  deals: ArraySchema(dealSchema).defined()
}).defined();
var dataSchema = ObjectSchema({
  user: userSchema
}).defined();
var getMyDealsResponseSchema = ObjectSchema({
  data: dataSchema
}).defined().strict(true);

var DealsV2Networker = /*#__PURE__*/function () {
  function DealsV2Networker(hostUrl) {
    classCallCheck(this, DealsV2Networker);
  ...
  createClass(DealsV2Networker, [{
    key: "getMyDeals",
    value: function () {
      var _getMyDeals = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(accessToken) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return this.axiosInstance.post(this.hostUrl, data, {
                  headers: {
              ...
              case 4:
                ...
                _context.next = 7;
                return getMyDealsResponseSchema.validate(response.data);
      ...
      function getMyDeals(_x) {
        return _getMyDeals.apply(this, arguments);
      }
  ...
  return DealsV2Networker;
}();

exports.DealsV2Networker = DealsV2Networker;
