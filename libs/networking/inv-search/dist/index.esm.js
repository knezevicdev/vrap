...
var carSchema = ObjectSchema({
  ...
  defectPhotos: ArraySchema(ObjectSchema({
    ...
    defectType: StringSchema().oneOf(Object.values(DefectType)).defined(),
...
export { DefectType, InvSearchNetworker, SoldStatus, SoldStatusInt };
