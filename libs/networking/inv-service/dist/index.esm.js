...
(function (SoldStatus) {
  ...
  SoldStatus["SALE_PENDING"] = "sales_pending";
  SoldStatus["SOLD"] = "sold";
  SoldStatus["DELIVERED"] = "delivered";
})(SoldStatus || (SoldStatus = {}));

var inventorySchema = ObjectSchema({
  payload: ArraySchema(ObjectSchema({
    id: NumberSchema().defined(),
    created: StringSchema().defined(),
    updated: StringSchema().defined(),
    vehicleVin: StringSchema().defined(),
    status: ObjectSchema({
      key: StringSchema().defined(),
      display: StringSchema().defined()
    }).defined(),
    miles: NumberSchema().defined(),
    purchasingID: NumberSchema().defined(),
    pricingID: NumberSchema().defined().nullable(),
    fyusionID: StringSchema().defined(),
    externalID: StringSchema().defined(),
    consignmentPartnerName: StringSchema().defined().nullable(),
    isListed: boolean().defined(),
    grade: StringSchema().defined().nullable()
  }).defined()).defined(),
  next_page: StringSchema().defined().nullable()
}).defined();
var getInventoryAvailabilityResponseSchema = ObjectSchema({
...
var InventoryServiceNetworker = /*#__PURE__*/function () {
  function InventoryServiceNetworker(hostUrl) {
    classCallCheck(this, InventoryServiceNetworker);
  ...
  createClass(InventoryServiceNetworker, [{
    key: "getInventoryAvailability",
    value: function () {
      var _getInventoryAvailability = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(vin) {
        var url, response, payload, _iterator, _step, item;

        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = "".concat(this.hostUrl, "/inventory?vin=").concat(vin);
                _context.next = 3;
              ...
              case 3:
                ...
                _context.next = 6;
                return getInventoryAvailabilityResponseSchema.validate(response.data);

              case 6:
                payload = response.data.data.payload;
                _iterator = _createForOfIteratorHelper(payload);
                _context.prev = 8;
      ...
      function getInventoryAvailability(_x) {
        return _getInventoryAvailability.apply(this, arguments);
      }
  ...
  return InventoryServiceNetworker;
}();

export { InventoryServiceNetworker as InvServiceNetworker, SoldStatusInt };
