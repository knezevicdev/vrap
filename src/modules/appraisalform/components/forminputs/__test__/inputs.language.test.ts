import * as lang from '../Inputs.language';

describe('form input in appraisal form language test', () => {
  test('test const', () => {
    expect(lang.commonLangInput).toEqual({
      yes: 'Yes',
      no: 'No',
      other: 'Other',
    ...
    expect(lang.FormFields).toEqual({
      first: {
      ...
      vehicleOptions: {
        label: 'Options (select all that apply)',
      },
      lookingToAccomplish: {
