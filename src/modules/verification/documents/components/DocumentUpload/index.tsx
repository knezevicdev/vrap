    ...
    <>
      <Wrapper>
        ...
        <FilePondContainer
          ...
          labelMaxFileSize="Min file resolution 300 x 300px."
          imageValidateSizeMinResolution={100000}
          imageValidateSizeLabelImageResolutionTooLow="he uploaded file is too large."
          imageValidateSizeLabelExpectedMinResolution="Max file size 25MB."
