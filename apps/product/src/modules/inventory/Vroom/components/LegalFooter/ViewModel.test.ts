  ...
  describe('getLegalText', () => {
    it('getLegalText returns an array of strings', () => {
      ...
      expect(viewModel.getLegalText()).toStrictEqual([
        'Price displayed does not include: Pre-delivery service charges of $285.50 (MA residents only - $300.50), Delivery charge of $799, FL residents only - Electronic registration filing charge of $15.00, or applicable taxes, title, tag and registration charges which will be calculated at the time of purchase.  Prices are subject to change.',
