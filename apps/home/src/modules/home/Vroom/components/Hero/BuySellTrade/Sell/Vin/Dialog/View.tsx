  ...
  return (
    ...
    >
      <DialogContainer>
        ...
        <Typography whiteSpace="nowrap" lineHeight="normal">
        ...
        <ListContainer>
          <List>
            ...
            <UL>
              {viewModel.carList.map((item) => (
                <li key={item}>
                  <Typography lineHeight="normal">{item}</Typography>
                </li>
              ))}
            </UL>
          </List>
          <List>
            <Typography lineHeight="normal" fontWeight="600">
              {viewModel.documentationTitle}
            </Typography>
            <UL>
              {viewModel.documentationList.map((item) => (
                <li key={item}>
                  <Typography lineHeight="normal">{item}</Typography>
                </li>
              ))}
