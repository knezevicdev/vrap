import {
  ...
  export const VehicleSoldDialog: React.FC<VehicleSoldDialog> = ({ close, carName }) => {
    return (
      <Container>
        <Close onClick={close}>
        ...
        <Line />
        <Content>
        <Body.Regular bold>{carName}</Body.Regular> is no longer available.Don’t worry. We have thousands of low-mileage, high-quality vehicles for you to choose from.
        </Content>
        <IconContainer>
